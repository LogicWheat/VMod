...
public class GIFImageReaderSpi extends ImageReaderSpi {
    ...
    private static final String readerClassName =
            "net.spaceeye.vmod.gif.GIFImageReader";

    private static final String[] writerSpiNames = {
            "net.spaceeye.vmod.gif.GIFImageWriterSpi"
    };
    ...
    public GIFImageReaderSpi() {
        super(vendorName,
                ...
                "net.spaceeye.vmod.gif.GIFStreamMetadataFormat",
                null, null,
                true,
                GIFImageMetadata.nativeMetadataFormatName,
                "net.spaceeye.vmod.gif.GIFImageMetadataFormat",
                null, null
        );
    }
