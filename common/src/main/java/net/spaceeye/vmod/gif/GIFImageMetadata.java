...
public class GIFImageMetadata extends GIFMetadata {
    ...
    // package scope
    public static final String nativeMetadataFormatName = "javax_imageio_gif_image_1.0";

    public static final String[] disposalMethodNames = {
            "none",
            "doNotDispose",
    ...
    public String getDisposalMethodString() {
        return disposalMethodNames[disposalMethod];
    }
    ...
    public void setFromTree(String formatName, Node root) {throw new IllegalStateException("Metadata is read-only!");}
    protected void mergeNativeTree(Node root) {throw new IllegalStateException("Metadata is read-only!");}
    protected void mergeStandardTree(Node root) {throw new IllegalStateException("Metadata is read-only!");}
