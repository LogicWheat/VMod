...
//TODO doesn't work with sodium and works strange sometimes
object ShipsColorModulator: ClientClosable() {
    ...
    fun setColor(id: Long, color: Color) { return; idToColor[id] = color.getRGBComponents(null) }
    fun setColor(id: Long, color: FloatArray) { return; idToColor[id] = color }
