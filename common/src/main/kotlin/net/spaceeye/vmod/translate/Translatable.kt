...
val NEW_TOTAL_MASS = s("New Total Mass")
val MASS_PER_BLOCK = s("Mass Per Block")
val SYNC_MASS_PER_BLOCK = s("Synchronize mass per block")
...
val DELETE = x("Delete")
val INVALID_FILENAME = x("Invalid Filename")
val FAILED_TO_MAKE_PRESET = x("Failed to make preset")
val MAKE_PRESET = x("Make Preset")
val NO_PRESETS = x("No Presets")
val PRESETS = x("Presets")
val SOMETHING_WENT_WRONG = x("Something went wrong!")
val CONFIRM = x("Confirm")
val ARE_YOU_SURE_YOU_WANT_TO_DELETE_IT = x("Are you sure you want to delete it?", "are_you_sure_you_want_to_delete_it")
val YES = x("Yes")
val NO = x("No")
...
val MASS_CHANGER_IS_DANGEROUS = x("THIS MODE IS DANGEROUS AND CAN DELETE SHIPS! USE IT AT YOUR OWN RISK", "mass_changer_is_dangerous")